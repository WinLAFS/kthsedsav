 ...
 */
public class LookupTestExample extends CommunicatingComponent {

	/*#%*/ private static Logger log = Logger.getLogger(LookupTestExample.class);
...
//	HashMap<String, String> pendingLookups;
	 ...
	 * @param registry
	 */
	public LookupTestExample(Scheduler scheduler, ComponentRegistry registry) {
...
//		pendingLookups = new HashMap<String, String>();
	...
	public static void main(String[] args) {
		...
		LookupTestExample app = new LookupTestExample(node.getScheduler(), node.getComponentRegistry());
...
//			lookups.put(no, tmp+":"+node.getId());
		...
		// now send a message to test transfer speed
		
		LookupTestMessage msg = new LookupTestMessage(question.toString(), myRef.getId().toString()+":"+(messageId++), DATA_TO_SEND ,System.currentTimeMillis());
		send(msg, myRef, node);
