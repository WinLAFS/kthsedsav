 ...
 */
public class DebugObjectSerializationCodecFactory implements ProtocolCodecFactory {
    private final DebugObjectSerializationEncoder encoder;

    private final DebugObjectSerializationDecoder decoder;

    /**
     * Creates a new instance with the {@link ClassLoader} of
     * the current thread.
     */
    public DebugObjectSerializationCodecFactory() {
     ...
     */
    public DebugObjectSerializationCodecFactory(ClassLoader classLoader) {
        encoder = new DebugObjectSerializationEncoder();
        decoder = new DebugObjectSerializationDecoder(classLoader);
    }
