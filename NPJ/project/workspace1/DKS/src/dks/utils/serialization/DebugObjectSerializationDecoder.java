 ...
 */
public class DebugObjectSerializationDecoder extends CumulativeProtocolDecoder {
     ...
     * the current thread.
     */
    public DebugObjectSerializationDecoder() {
     ...
     */
    public DebugObjectSerializationDecoder(ClassLoader classLoader) {
        if (classLoader == null) {
