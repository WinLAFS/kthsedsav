 ...
 * generated in the bookpublisherusacallback package. 
...
public class ObjectFactory {
    ...
    private final static QName _BookOrderDone_QNAME = new QName("http://bookpublisherUSAcallback/", "bookOrderDone");
    private final static QName _BookOrderDoneResponse_QNAME = new QName("http://bookpublisherUSAcallback/", "bookOrderDoneResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: bookpublisherusacallback
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bookpublisherUSAcallback/", name = "bookOrderDone")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bookpublisherUSAcallback/", name = "bookOrderDoneResponse")
