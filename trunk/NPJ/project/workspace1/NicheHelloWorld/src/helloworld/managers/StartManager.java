package helloworld.managers;

import helloworld.aggregators.ServiceSupervisor;
import helloworld.events.ServiceAvailabilityChangeEvent;
...
public class StartManager implements BindingController, LifeCycleController {
    ...
    private final static String APPLICATION_PREFIX = "NicheHelloWorld_0/";
    ...
    private void startScript() {
        System.err.println("Starting HelloWorld StartManager.");
