 ...
 *          Roberto $
 */
public class ReliableLookupRequestEvent extends LookupRequestEvent {

	public boolean resent = false;

	public ReliableLookupRequestEvent(BigInteger id, LookupStrategy strategy,
			Class oIssueeventToIssue) {
		super(id, strategy, oIssueeventToIssue);
	}
