 ...
 */
public class DebugObjectSerializationEncoder extends ProtocolEncoderAdapter {
    private int maxObjectSize = Integer.MAX_VALUE; // 2GB
    private int initBufferSize = 64; // 2GB

    /**
     * Creates a new instance.
     */
    public DebugObjectSerializationEncoder() {}
    ...
    public int getInitBufferSize() { return (initBufferSize); }
    public void setInitBufferSize(int ibs) { initBufferSize = ibs; }
    ...
    public void encode(IoSession session, Object message,
        ...
        IoBuffer buf = IoBuffer.allocate(initBufferSize);
