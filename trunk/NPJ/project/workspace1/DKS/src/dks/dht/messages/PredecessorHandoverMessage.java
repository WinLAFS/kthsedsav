...
import static dks.messages.MessageTypeTable.MSG_TYPE_DHT_PRED_HANDOVER;
import dks.addr.DKSRef;
import dks.messages.Message;

/**
 * The <code>PredecessorHandoverMessage</code> class
 *
 * @author Ahmad Al-Shishtawy
 * @version $Id: PredecessorHandoverMessage.java 294 2006-05-05 17:14:14Z alshishtawy $
 */
public class PredecessorHandoverMessage extends Message implements HandoverMessage {
	/**
	 * @serialVersionUID - 
	 */
	private static final long serialVersionUID = 8797222042649117215L;

	public static final int messageType = MSG_TYPE_DHT_PRED_HANDOVER;
	...
	public PredecessorHandoverMessage() {
		super();
	}
	 ...
	 * @param buffer
	 */
	public PredecessorHandoverMessage(Object buffer, int id , int total) {
		super();
	 ...
	 * @param to
	 */
	public PredecessorHandoverMessage(Object buffer, int chunkID, int totalChunks, DKSRef from, DKSRef to) {
		super();
		this.buffer = buffer;
