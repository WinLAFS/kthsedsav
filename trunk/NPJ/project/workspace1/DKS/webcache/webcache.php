<?php
$filename = "/home/roberto/public_html/dks_new/dksRefs";
$parameters = "/home/roberto/public_html/dks_new/parameters";
...
if($_GET['addDKSParameters'] != null && $_GET['addDKSParameters'] != '') {
...
if($_GET['addDKSRef'] != null && $_GET['addDKSRef'] != '') {
	// Let's make sure the file exists and is writable first.
	if (is_writable($filename)) {
