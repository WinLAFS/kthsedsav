...
public class RWAbortableConsensusInit extends Init {
	...
	public RWAbortableConsensusInit(String commandScript, Set<Address> neighborSet, Address self) {
		super();
